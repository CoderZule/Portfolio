...
const ProjectBox = ({ projectPhoto, projectName  }) => {
  const desc = {
    ...
    MyDoctorDesc: "A comprehensive web platform for streamlined medical appointment scheduling. It features an intuitive interface for patients to book, manage, and track their appointments, while enabling healthcare professionals to organize their schedules efficiently, enhancing the overall patient-doctor experience.",
    MyDoctorGithub: "https://github.com/CoderZule/MyDoctors",
